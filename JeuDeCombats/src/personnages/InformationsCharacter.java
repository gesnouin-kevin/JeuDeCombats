...
public abstract class InformationsCharacter {
	...
	private static int widthSpritePersoIdle[]={182,299,234,0,0,207};
	private static int heightSpritePersoIdle[]={345,366,321,0,0,350};
	private static int nbSpritePersoIdle[]={4,4,4,0,0,4};
	
	private static int widthSpritePersoWalking[]={182,326,233,0,0,230};
	private static int heightSpritePersoWalking[]={345,353,262,0,0,360};
	private static int nbSpritePersoWalking[]={5,4,8,0,0,8};
	
	private static int widthSpritePersoJump[]={182,277,216,0,0,205};
	private static int heightSpritePersoJump[]={558,618,539,0,0,428};
	private static int nbSpritePersoJump[]={4,4,4,0,0,4};
	
	private static int widthSpritePersoCrouch[]={182,277,217,0,0,205};
	private static int heightSpritePersoCrouch[]={228,272,233,0,0,266};
	private static int nbSpritePersoCrouch[]={1,1,2,0,0,1};
	
	private static int widthSpritePersoBlocking[]={182,295,210,0,0,219};
	private static int heightSpritePersoBlocking[]={350,411,304,0,0,340};
	private static int nbSpritePersoBlocking[]={2,1,1,0,0,2};
	
	private static int widthSpritePersoPunch[]={182,379,319,0,0,384};
	private static int heightSpritePersoPunch[]={341,353,317,0,0,340};
	private static int nbSpritePersoPunch[]={3,3,2,0,0,3};
	
	private static int widthSpritePersoKick[]={182,402,325,0,0,366};
	private static int heightSpritePersoKick[]={349,361,300,0,0,388};
	private static int nbSpritePersoKick[]={3,3,3,0,0,5};
	
	private static int widthSpritePersoHit[]={182,299,245,0,0,290};
	private static int heightSpritePersoHit[]={287,343,318,0,0,306};
	private static int nbSpritePersoHit[]={4,3,2,0,0,2};
	
	private static int widthSpritePersoCrouchHit[]={182,299,227,0,0,237};
	private static int heightSpritePersoCrouchHit[]={241,295,277,0,0,248};
	private static int nbSpritePersoCrouchHit[]={1,1,3,0,0,1};
	
	private static int widthSpritePersoKo[]={182,388,378,0,0,357};
	private static int heightSpritePersoKo[]={312,384,266,0,0,283};
	private static int nbSpritePersoKo[]={3,5,5,0,0,4};
	
	private static int widthSpritePersoVictory[]={180,299,240,0,0,203};
	private static int heightSpritePersoVictory[]={460,536,486,0,0,384};
	private static int nbSpritePersoVictory[]={3,2,4,0,0,3};
